...
enum DateFormat { ddmmyyyyDash, mmddyyyyDash, ddmmyyyySlash, mmddyyyySlash, ddmmmmyyyyDash, yyyymmddhhmmssDashSpaceColon24Hr, yyyymmddhhmmssDashSpaceColon12Hr }
...
extension on DateFormat {
  ...
  String get value {
    switch(this) {
      ...
      case DateFormat.yyyymmddhhmmssDashSpaceColon12Hr: return "yyyy-MM-dd hh:mm:ss a";
    }
  }
